// ======================================================================
// UART_Exam_IAP.v generated from TopDesign.cysch
// 10/04/2021 at 18:39
...
module top ;
	...
	wire [0:0] tmpOE__LED_P21_net;
	wire [0:0] tmpFB_0__LED_P21_net;
	wire [0:0] tmpIO_0__LED_P21_net;
	wire [0:0] tmpINTERRUPT_0__LED_P21_net;
	electrical [0:0] tmpSIOVREF__LED_P21_net;
	...
	cy_psoc3_pins_v1_10
		...
		LED_P21
		 (.oe(tmpOE__LED_P21_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_P21_net[0:0]}),
		  .io({tmpIO_0__LED_P21_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_P21_net),
		  .interrupt({tmpINTERRUPT_0__LED_P21_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_P21_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_0 mUART1 (
        ...
        .tx_en(Net_13),
        .tx_interrupt(Net_14));
    defparam mUART1.Address1 = 0;
    defparam mUART1.Address2 = 0;
    defparam mUART1.EnIntRXInterrupt = 0;
    defparam mUART1.EnIntTXInterrupt = 0;
    defparam mUART1.FlowControl = 0;
    defparam mUART1.HalfDuplexEn = 0;
    defparam mUART1.HwTXEnSignal = 1;
    defparam mUART1.NumDataBits = 8;
    defparam mUART1.NumStopBits = 1;
    defparam mUART1.ParityType = 0;
    defparam mUART1.RXEnable = 1;
    defparam mUART1.TXEnable = 1;
